...
class Constants {
  ...
  static List<Item> jatuhanList = [
    Item(
      ...
      "assets/videos/jatuhan_satu.mp4",
    ...
    Item(
      ...
      "assets/videos/jatuhan_tiga.mp4",
    ...
    Item(
      ...
      "assets/videos/jatuhan_empat.mp4",
    ...
    Item(
      ...
      "assets/videos/jatuhan_lima.mp4",
    ...
    Item(
      ...
      "assets/videos/jatuhan_punggung.mp4",
    ...
    Item(
      ...
      "assets/videos/jatuhan_saweran.mp4",
    ...
    Item(
      ...
      "assets/videos/guntingan_pinggang.mp4",
    ...
    Item(
      ...
      "assets/videos/guntingan_kaki.mp4",
    ...
    Item(
      ...
      "assets/videos/jatuhan_circle.mp4",
      // "https://drive.google.com/file/d/1Nag7u0eGgU0gZfGAHekGFsJZRm_L04VJ/view?usp=share_link",
    ),
  ];
  ...
  static List<Item> tangkapanList = [
    Item(
      ...
      "assets/videos/tangkapan_luar.mp4",
    ...
    Item(
      ...
      "assets/videos/tangkapan_dalam.mp4",
